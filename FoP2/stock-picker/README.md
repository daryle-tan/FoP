...
Firstly, write down the requirements for your functions - inputs, outputs, and edge cases. Next, describe in words (not code!) how you would determine which days are best to buy and sell. (Drawing a diagram or flowchart is acceptable as well.) Finally, turn your description into code - and push both your code and description up to GitHub.
